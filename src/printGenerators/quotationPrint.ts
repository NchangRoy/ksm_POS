...
// Ported from the main Billing frontend's generateQuotationHTML
// (src/api/printGenerators/quotationPrint.ts) — same layout/markup, adapted to
// the POS terminal's SellerSession shape. Renders the real backend DevisResponse,
// not a local mock.
    ...
    <div class="a4-page">
        ...
        <footer class="footer">
            <div class="terms">
                ...
                <p class="terms-text">This quotation is valid until the date specified above. All payments should be made to the account details provided separately.</p>
            </div>
