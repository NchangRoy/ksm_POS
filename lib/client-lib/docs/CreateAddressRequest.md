...
------------ | ------------- | ------------- | -------------
**addressableType** | **string** |  | [default to undefined]
**addressableId** | **string** |  | [default to undefined]
...
**poBox** | **string** |  | [optional] [default to undefined]
**isDefault** | **boolean** |  | [optional] [default to undefined]
**neighborhood** | **string** |  | [optional] [default to undefined]
**informalDescription** | **string** |  | [optional] [default to undefined]
...
```typescript
import { CreateAddressRequest } from './api';

const instance: CreateAddressRequest = {
    addressableType,
    addressableId,
    type,
    addressLine1,
