...
**paperFormat** | **string** |  | [optional] [default to undefined]
**lengthOfVatInvoiceNumber** | **number** |  | [optional] [default to undefined]
**prefixOfVatInvoiceNumber** | **string** |  | [optional] [default to undefined]
...
```typescript
import { UpdateAdministrativeGeneralOptionsRequest } from './api';

const instance: UpdateAdministrativeGeneralOptionsRequest = {
    agencyId,
